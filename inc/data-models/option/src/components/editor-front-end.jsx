...
const Editor = ( props, blockOptions ) => {
    ...
    return <>    
        <div tw={"w-[full] h-fit overflow-visible relative"}>            
            <div tw="
                left-1/2 -translate-x-1/2 absolute top-0 p-4 bg-blue-100/30 h-fit flex gap-8 flex-wrap border-b-[10vh] border-b-white box-border
                w-screen sm:(w-[95vw]) md:(w-[80vw] lg:(w-[65vw]))"
            >
