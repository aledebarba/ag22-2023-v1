...
const blockOptions = {
        ...
        layout:[
            { ref: "link", type: "textControl", label: "O link para onde o usuário deve seguir caso clieque na marca do cliente. (ou deixe vazio para não criar um link)", width:"40%" },
            { ref: "logo", type: "imageSelect", label: "A marca do cliente que vai aparcer na seção de clientes", width:"40%" },
            { ref: "info", type: "textareaControl", label: "Alguma informação sobre o cliente que vai aparecer quando o usuário passar o mouse por cima da marca", width:"100%" },
        ],        
    }
