...
/***/ "./src/components/action-buttons.js":
/*!******************************************!*\
  !*** ./src/components/action-buttons.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/components/media-components.js":
/*!********************************************!*\
  !*** ./src/components/media-components.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
const ImagePlaceholder = props => /*#__PURE__*/React.createElement("div", {
  style: {
    position: "relative",
    width: "100%",
    paddingTop: "100%",
    backgroundColor: "#c8c8c8",
    backgroundImage: props.showBackground ? `url('data:image/svg+xml,%3Csvg xmlns="http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg" width="1em" height="1em" viewBox="0 0 20 20"%3E%3Cpath fill="rgba(0,0,0,0.3)" d="M2.25 1h15.5c.69 0 1.25.56 1.25 1.25v15.5c0 .69-.56 1.25-1.25 1.25H2.25C1.56 19 1 18.44 1 17.75V2.25C1 1.56 1.56 1 2.25 1zM17 17V3H3v14h14zM10 6c0-1.1-.9-2-2-2s-2 .9-2 2s.9 2 2 2s2-.9 2-2zm3 5s0-6 3-6v10c0 .55-.45 1-1 1H5c-.55 0-1-.45-1-1V8c2 0 3 4 3 4s1-3 3-3s3 2 3 2z"%2F%3E%3C%2Fsvg%3E')` : "linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(250,250,250,1) 100%)",
...
/***/ "./src/components/media-gallery-button.js":
/*!************************************************!*\
  !*** ./src/components/media-gallery-button.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _custom_image_select_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./custom-image-select.scss */ "./src/components/custom-image-select.scss");
...
/* harmony import */ var _action_buttons__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./action-buttons */ "./src/components/action-buttons.js");
/* harmony import */ var _media_components__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./media-components */ "./src/components/media-components.js");
...
function CustomImageSelect({
  ...
  const [imageLoaded, setImageLoaded] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(false);
  if (!setMedia) {
    setMedia = CALLBACK;
    console.error("setMedia callback function is required, in absence of callback function, console.log will be used");
  }
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "custom-image-select " + className
  }, /*#__PURE__*/React.createElement(_media_components__WEBPACK_IMPORTED_MODULE_5__.ImagePlaceholder, {
    showBackground: !imageLoaded
  ...
  }), /*#__PURE__*/React.createElement(_action_buttons__WEBPACK_IMPORTED_MODULE_4__.ActionButtonTrash, {
    handleRemoveImage: handleRemoveImage
  }))), label && !children && /*#__PURE__*/React.createElement("div", {
    className: "font-sans text-sm text-blue-500"
  }, label), /*#__PURE__*/React.createElement("div", {
    className: "mt-4 text-sm text-slate-500"
  }, children), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.MediaUploadCheck, {
    className: "buttons"
...
/***/ "./src/components/custom-image-select.scss":
/*!*************************************************!*\
  !*** ./src/components/custom-image-select.scss ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/components */ "@wordpress/components");
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _components_media_gallery_button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/media-gallery-button */ "./src/components/media-gallery-button.js");
...
const blockOptions = {
  ...
  attributes: {
    ...
    svg: {
      type: "string",
      default: "cole aqui o código SVG"
    }
  },
  layout: [{
    ref: "desc",
...
const RenderInterface = props => {
  const [attributes, setAttributes] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(props.attributes);
  ...
  return /*#__PURE__*/React.createElement(_StyledDiv, null, Object.keys(props.attributes).map((attribute, index) => {
    ...
    return /*#__PURE__*/React.createElement(_StyledDiv2, {
      key: index,
      $_css: layout.width
    }, /*#__PURE__*/React.createElement(_StyledDiv3, null, layout.label), layout.type === "textControl" && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
      className: "w-full",
      value: attributes[attribute],
      onChange: value => onChange(attribute, value)
    }), layout.type === "icon" && /*#__PURE__*/React.createElement(IconSelectControl, {
      icon: attributes[attribute],
      onSelect: value => onChange(attribute, value)
    }), layout.type === "imageSelect" && /*#__PURE__*/React.createElement(_components_media_gallery_button__WEBPACK_IMPORTED_MODULE_3__.CustomImageSelect, {
      media: attributes[attribute],
      setMedia: media => onChange(attribute, media.url),
      fit: "cover"
    }, /*#__PURE__*/React.createElement("p", {
      className: "font-sans"
    }, "Selecione uma imagem da galeria ou fa\xE7a upload de uma nova.")), layout.type === "colorControl" && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ColorControl, {
      className: "w-full",
      value: attributes[attribute],
      onChange: value => onChange(attribute, value)
    }), layout.type === "selectControl" && /*#__PURE__*/React.createElement(SelectControl, {
      className: "w-full",
      value: attributes[attribute],
      onChange: value => onChange(attribute, value),
      options: attributes[attribute].options
    }), layout.type === "textareaControl" && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextareaControl, {
      style: {
        maxHeight: "100vh"
      },
      value: attributes[attribute],
    ...
    }), layout.type === "imageGallery" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h3", null, "Imagens extras"), /*#__PURE__*/React.createElement("div", {
      className: "flex flex-wrap"
    }, attributes[attribute].map((item, index) => /*#__PURE__*/React.createElement("div", {
    ...
    })))))), /*#__PURE__*/React.createElement(_components_media_gallery_button__WEBPACK_IMPORTED_MODULE_3__.MediaGalleryButton, {
      media: attributes[attribute].map(media => media.id),
      setMedia: media => media.map(item => ({
        id: item.id,
        url: item.url,
        alt: item.alt
      })),
  ...
  return /*#__PURE__*/React.createElement(_StyledDiv4, {
    $_css2: [{
      ...
      "transitionDuration": "300ms"
        ...
        `]
  }, /*#__PURE__*/React.createElement(_StyledDiv5, null, /*#__PURE__*/React.createElement(_StyledDiv6, null, /*#__PURE__*/React.createElement(_iconify_react__WEBPACK_IMPORTED_MODULE_5__.Icon, {
    icon: icon,
    width: "100%"
  })), /*#__PURE__*/React.createElement(_StyledButton, null, /*#__PURE__*/React.createElement(_StyledA, {
    href: src,
    target: "_blank",
    rel: "noreferrer"
  }, /*#__PURE__*/React.createElement(_iconify_react__WEBPACK_IMPORTED_MODULE_5__.Icon, {
    icon: "octicon:search-16"
  }), /*#__PURE__*/React.createElement("span", null, selectLabel))), /*#__PURE__*/React.createElement(_StyledButton2, {
    onClick: () => onSelect("")
  }, /*#__PURE__*/React.createElement(_iconify_react__WEBPACK_IMPORTED_MODULE_5__.Icon, {
    icon: "mdi:trash"
  }), /*#__PURE__*/React.createElement("span", null, "Limpar \xEDcone")), /*#__PURE__*/React.createElement(_StyledTextControl, {
    value: icon,
    onChange: value => onSelect(value)
  })));
};
const GalleryOfImages = props => {
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h3", null, "Imagens extras"), /*#__PURE__*/React.createElement("div", {
    className: "flex flex-wrap"
  }, props.attributes.images.map((item, index) => /*#__PURE__*/React.createElement("div", {
    className: "extra-image",
    key: index
  }, /*#__PURE__*/React.createElement("div", {
    className: "image-container"
    ...
    className: "grid w-full h-20 text-white bg-white rounded shadow-lg place-content-center"
  }, /*#__PURE__*/React.createElement(_components_media_gallery_button__WEBPACK_IMPORTED_MODULE_3__.MediaGalleryButton, {
...
var _StyledDiv = (0,styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])("div").withConfig({
  displayName: "src___StyledDiv",
  componentId: "sc-1vy5zen-0"
})({
  "display": "flex",
  "height": "fit-content",
  "width": "100%",
...
var _StyledDiv2 = (0,styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])("div").withConfig({
  displayName: "src___StyledDiv2",
  componentId: "sc-1vy5zen-1"
})(["flex:1 0 ", ";"], p => p.$_css);
var _StyledDiv3 = (0,styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])("div").withConfig({
  displayName: "src___StyledDiv3",
  componentId: "sc-1vy5zen-2"
})({
  "paddingTop": "1rem",
  "paddingBottom": "1rem",
  "paddingLeft": "0px",
...
var _StyledDiv4 = (0,styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])("div").withConfig({
  displayName: "src___StyledDiv4",
  componentId: "sc-1vy5zen-3"
})(["", ""], p => p.$_css2);
var _StyledDiv5 = (0,styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])("div").withConfig({
  displayName: "src___StyledDiv5",
  componentId: "sc-1vy5zen-4"
})({
  "display": "grid",
  "width": "12vw",
  "maxWidth": "280px",
...
var _StyledDiv6 = (0,styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])("div").withConfig({
  displayName: "src___StyledDiv6",
  componentId: "sc-1vy5zen-5"
})({
  "gridColumnStart": "1",
...
var _StyledButton = (0,styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])("button").withConfig({
  displayName: "src___StyledButton",
  componentId: "sc-1vy5zen-6"
})({
...
var _StyledA = (0,styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])("a").withConfig({
  displayName: "src___StyledA",
  componentId: "sc-1vy5zen-7"
})({
  "display": "flex",
  "flexWrap": "nowrap",
  "alignItems": "center",
...
var _StyledButton2 = (0,styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])("button").withConfig({
  displayName: "src___StyledButton2",
  componentId: "sc-1vy5zen-8"
})({
  "gridColumn": "span 2 / span 2",
  "gridColumnStart": "2",
  "display": "flex",
...
var _StyledTextControl = (0,styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl).withConfig({
  displayName: "src___StyledTextControl",
  componentId: "sc-1vy5zen-9"
})({
