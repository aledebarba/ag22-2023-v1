...
function CustomImageSelect({
  ...
  }, /*#__PURE__*/React.createElement(_media_components__WEBPACK_IMPORTED_MODULE_5__.ImagePlaceholder, null, image && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("img", {
    src: image.url || image,
    alt: image.alt || "",
    style: {
...
const blockOptions = {
  ...
  layout: [{
    ref: "cia",
    type: "textControl",
    label: "O nome completo da empresa detentora da marca.",
    width: "50%"
  }, {
    ref: "icone",
    type: "icon",
    ...
    ref: "poster",
    type: "imageSelect",
    label: "A imagem principal desse post.",
    width: "40%"
  }, {
    ref: "logo",
    type: "imageSelect",
  ...
  //{ ref: "gallery", type: "imageGallery", label: "Imagens que fazem parte do post", width:"100%" },
  {
    ...
    label: "A descrição do post.",
    width: "100%"
  }, {
    ref: "link",
    type: "textControl",
    label: "O link para o post.",
    width: "100%"
  }]
};
...
const RenderInterface = props => {
  ...
  return /*#__PURE__*/React.createElement(_StyledDiv, null, Object.keys(props.attributes).map((attribute, index) => {
    ...
    return /*#__PURE__*/React.createElement(_StyledDiv2, {
      key: index,
      $_css: layout.width
    }, /*#__PURE__*/React.createElement(_StyledP, null, layout.label), layout.type === "textControl" && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
      className: "w-full",
      value: attributes[attribute],
      onChange: value => onChange(attribute, value)
    }), layout.type === "icon" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_StyledDiv3, null, /*#__PURE__*/React.createElement(_iconify_react__WEBPACK_IMPORTED_MODULE_4__.Icon, {
    ...
    }, "Clear"))), layout.type === "imageSelect" && /*#__PURE__*/React.createElement(_components_media_gallery_button__WEBPACK_IMPORTED_MODULE_3__.CustomImageSelect, {
...
var _StyledButton = (0,styled_components__WEBPACK_IMPORTED_MODULE_5__["default"])("button").withConfig({
